...
const Card = ({pairCreatedAt,chainId,dexId,pairAddress,baseToken,quoteToken,priceNative,priceUsd}) => {
  return (
    <div className='cardItem'>
        <div className='cardChild'>
            ...
            <div className='cardTextCon'>
                ...
                <div className='cardText'>
                    <span>{formatTimestamp(pairCreatedAt)}</span>
                    <span>{chainId}</span>
                    <span>{dexId}</span>
                    <span >{pairAddress.split("").splice(0,4).join("")}</span>
                </div>
            </div>
        ...
        <div className='cardChild'>
            ...
            <div className='cardTextCon'>
                ...
                <div  className='cardText'>
                    ...
                    <span>{baseToken.address.split("").splice(0,4).join("")}</span>
                </div>
            </div>
            <div className='cardIcon'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <div className='cardChild'>
            ...
            <div className='cardTextCon'>
                ...
                <div className='cardText'>
                    ...
                    <span>{quoteToken.address.split("").splice(0,4).join("")}</span>
                </div>
            </div>
            <div className='cardIcon'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
